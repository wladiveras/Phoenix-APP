        ...
        <div class="error-container">
            <div class="error-wrapper">
                <div class="error-inner has-text-centered">
                    ...
                    <h3>Não foi possivel encontrar a pagina</h3>
                    <p>
                        A pagina que você está procurando não existe. Por favor tente novamente ou entre em contato
                        conosco caso o problema persista.
                    </p>
                    <div class="button-wrap">
                        <V-Button color="primary" elevated :to="{ name: 'index' }"> Tudo bem, vamos voltar </V-Button>
                    </div>
                </div>
            </div>
        </div>
