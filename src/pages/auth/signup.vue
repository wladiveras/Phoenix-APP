        ...
        <div id="vuero-signup" class="signup-wrapper">
            <div class="signup-steps" :class="[step === 0 && 'is-hidden']">
                <div class="steps-container">
                    <div class="step-icon is-active" :class="[step >= 1 && 'is-active', step < 1 && 'is-inactive']">
                        <div class="inner">
                            <i aria-hidden="true" class="iconify" data-icon="feather:user"></i>
                        </div>
                        <span class="step-label">Profile Pic</span>
                    </div>
                    <div class="step-icon" :class="[step >= 2 && 'is-active', step < 2 && 'is-inactive']">
                        <div class="inner">
                            <i aria-hidden="true" class="iconify" data-icon="feather:shield"></i>
                        </div>
                        <span class="step-label">Account</span>
                    </div>
                    <div class="step-icon" :class="[step >= 3 && 'is-active', step < 3 && 'is-inactive']">
                        <div class="inner">
                    ...
                    <div class="container">
                        ...
                        <div class="columns signup-columns" :class="[step !== 0 && 'is-hidden']">
                            <div class="column is-4 is-offset-1">
                                <h1 id="main-signup-title" class="title is-3 signup-title">Become a Vuero</h1>
                                ...
                                <div class="signup-card">
                                    <form class="signup-form is-mobile-spaced" @submit.prevent>
                                        ...
                                        <div class="button-wrap has-help">
                                            <V-Button color="primary" size="big" bold fullwidth rounded @click="step++">
                                                Continue
                                            </V-Button>
                                            <span>
                                                Or
                        ...
                        <div class="columns signup-columns" :class="[step !== 1 && 'is-hidden']">
                            <form class="column is-8" @submit.prevent>
                                <div class="signup-profile-wrapper">
                                    ...
                                    <div class="picture-selector">
                                        <div class="image-container">
                                            ...
                                            <div class="upload-button" role="button" @click="uploadModalOpen = true">
                                ...
                                <div class="button-wrap is-centered has-text-centered">
                                    <V-Button color="primary" size="big" rounded lower @click="step++">
                                        Continue
                                    </V-Button>
                                </div>
                            </form>
                        ...
                        <div class="columns signup-columns" :class="[step !== 2 && 'is-hidden']">
                            <div class="column is-4 is-offset-4 username-form">
                                ...
                                <h2 class="subtitle signup-subtitle has-text-centered">
                                    Your username is how others will find you on Vuero so pick a good one. You can
                                    change it later.
                                </h2>
                                            ...
                                            <V-Field>
                                                <V-Control class="has-switch">
                                                    ...
                                                    <label for="send-marketing" class="form-switch ml-auto">
                                                        <input id="send-marketing" type="checkbox" class="is-switch" />
        ...
        >
            ...
            <template #action>
                <V-Field grouped>
                    ...
                    <V-Control>
                        <V-Button class="upload-result" size="big" outlined disabled> Confirm </V-Button>
                    </V-Control>
                </V-Field>
            </template>
        </V-Modal>
