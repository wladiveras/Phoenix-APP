...
export const datatableV1 = {
    ...
    data: {
        ...
        data: [
            [0, "/demo/avatars/8.jpg", "Erik Kovalsky", "Product Manager", "busy", true],
            ...
            [4, "/images/avatars/placeholder-f.jpg", "Kaylee Jennings", "Web Developer", "available", true],
            ...
            [7, "/images/avatars/placeholder-m.jpg", "Paul Morris", "Backend Developer", "available", true],
            [8, "/demo/avatars/23.jpg", "Irina Vierbovsky", "Project Manager", "available", true],
            [9, "/demo/avatars/28.jpg", "Edouard Falant", "Web Developer", "busy", true],
            [10, "/images/avatars/placeholder-f.jpg", "Shana Williams", "Sales Manager", "offline", true],
            [11, "/images/avatars/placeholder-m.jpg", "Benjamin Hoffman", "Product Manager", "offline", true],
            [12, "/demo/avatars/39.jpg", "Alejandro Badajoz", "Web Developer", "busy", true],
            [13, "/demo/avatars/21.jpg", "Elizabeth Fisher", "Mobile Developer", "available", true],
