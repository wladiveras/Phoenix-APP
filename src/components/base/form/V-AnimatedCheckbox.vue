...
type AnimatedCheckboxColor = undefined | "primary" | "info" | "success" | "warning" | "danger" | "purple"
...
const props = defineProps({
    ...
    color: {
        ...
        validator: (value: AnimatedCheckboxColor) => {
            ...
            if ([undefined, "primary", "info", "success", "warning", "danger", "purple"].indexOf(value) === -1) {
                console.warn(
