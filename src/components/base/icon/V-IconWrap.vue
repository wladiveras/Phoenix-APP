    ...
    size: {
        ...
        validator: (value: IconWrapDark) => {
            ...
            if ([undefined, "large"].indexOf(value) === -1) {
                console.warn(`V-IconWrap: invalid "${value}" size. Should be large or undefined`)
                return false
            }
    ...
    dark: {
        ...
        validator: (value: IconWrapDark) => {
            ...
            if ([undefined, "1", "2", "3", "4", "5", "6"].indexOf(value) === -1) {
                console.warn(`V-IconWrap: invalid "${value}" dark. Should be 1, 2, 3, 4, 5, 6 or undefined`)
                return false
            }
...
<template>
    ...
    >
        ...
        />
        <i v-else-if="isIconify" aria-hidden="true" class="iconify" :data-icon="icon"></i>
