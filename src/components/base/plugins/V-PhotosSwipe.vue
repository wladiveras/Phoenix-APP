...
<template>
    <div ref="galleryElement" class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
        <figure
        ...
        >
            ...
            >
                <img
                    ...
                    :alt="item.alt"
                    itemprop="thumbnail"
                    @error.once="$event.target.src = `https://via.placeholder.com/${item.w}x${item.h}`"
                />
            </a>
        </figure>
    </div>
