...
const emit = defineEmits(["init", "refresh", "update", "page", "sort", "perpage", "search"])
...
const registerEvents = () => {
    if (wrapperElement.value) {
        const searchElement = wrapperElement.value.querySelector(".dataTable-input") as HTMLInputElement
        const pageLimitElement = wrapperElement.value.querySelector(".dataTable-selector") as HTMLSelectElement
        const paginationElement = wrapperElement.value.querySelector(".dataTable-pagination") as HTMLElement
