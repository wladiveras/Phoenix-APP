    ...
    size: {
        ...
        validator: (value: LoaderSize) => {
            ...
            if ([undefined, "small", "large", "xl"].indexOf(value) === -1) {
                console.warn(`V-Loader: invalid "${value}" size. Should be small, large, xl or undefined`)
                return false
            }
    ...
    card: {
        ...
        validator: (value: LoaderWrapperRadius) => {
            ...
            if ([undefined, "regular", "smooth", "rounded"].indexOf(value) === -1) {
                console.warn(`V-Loader: invalid "${value}" card. Should be regular, smooth, rounded or undefined`)
                return false
            }
