...
const props = defineProps({
    ...
    separator: {
        ...
        validator: (value: BreadcrumbSeparator) => {
            ...
            if ([undefined, "arrow", "bullet", "dot", "succeeds"].indexOf(value) === -1) {
                console.warn(
    ...
    align: {
        ...
        validator: (value: BreadcrumbAlign) => {
            ...
            if ([undefined, "center", "right"].indexOf(value) === -1) {
                console.warn(`V-Breadcrumb: invalid "${value}" align. Should be center, right or undefined`)
                return false
            }
        ...
        <ul>
            ...
            >
                <RouterLink v-if="item.to" class="breadcrumb-item" itemprop="item" :to="item.to">
                    ...
                    <meta v-if="item.hideLabel && withIcons && !!item.icon" itemprop="name" :content="item.label" />
