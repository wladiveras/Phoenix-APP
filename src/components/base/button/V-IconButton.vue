...
type IconButtonColor = undefined | "primary" | "info" | "success" | "warning" | "danger" | "white"
        ...
        dark: {
            ...
            validator: (value: IconButtonDark) => {
                ...
                if (["1", "2", "3", "4", "5", "6"].indexOf(value) === -1) {
                    console.warn(`V-IconButton: invalid "${value}" dark. Should be 1, 2, 3, 4, 5, 6 or undefined`)
                    return false
                }
