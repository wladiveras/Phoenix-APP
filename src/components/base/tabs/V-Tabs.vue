    ...
    type: {
        ...
        validator: (value: TabsType) => {
            ...
            if ([undefined, "boxed", "toggle", "rounded"].indexOf(value) === -1) {
                console.warn(`V-Tabs: invalid "${value}" type. Should be boxed, toggle, rounded or undefined`)
                return false
            }
    ...
    align: {
        ...
        validator: (value: TabsType) => {
            ...
            if ([undefined, "centered", "right"].indexOf(value) === -1) {
                console.warn(`V-Tabs: invalid "${value}" align. Should be centered, right or undefined`)
                return false
            }
