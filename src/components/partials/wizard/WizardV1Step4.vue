    ...
    dropzone.value.uploadFiles = async (files: any) => {
        for (let i = 0; i < files.length; i++) {
            ...
            for (let step = 0; step < totalSteps; step++) {
                ...
                dropzone.value.emit("uploadprogress", file, file.upload.progress, file.upload.bytesSent)
    ...
    <div class="step-content">
        ...
        <div v-if="!isUploading" class="page-placeholder is-files">
            <div class="placeholder-content">
                ...
                <a class="action-link toggle-uploader-link" @click="isUploading = true"> Add Files </a>
            </div>
        </div>
