...
<template>
    <div class="demo-card">
        ...
        <div v-if="!props.frontmatter.disable_code || !props.frontmatter.disable_example" class="card-inner">
            <div v-if="!props.frontmatter.disable_code" class="demo-example">
                <slot name="example"></slot>
            </div>

            <div v-if="!props.frontmatter.disable_code && displayCode" class="demo-code-wrapper">
                <div class="demo-code">
                    <slot name="code"></slot>
                </div>
