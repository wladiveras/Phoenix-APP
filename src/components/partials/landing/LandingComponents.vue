...
<template>
    <div id="demo-elements" :class="[props.activeTab === 'elements' && 'is-active']" class="tab-content has-text-left">
    ...
    <!--Forms-->
    <div id="demo-forms" :class="[props.activeTab === 'forms' && 'is-active']" class="tab-content has-text-left">
        <div class="columns is-multiline">
