...
<template>
    <V-Dropdown icon="feather:more-vertical" right>
        <template #content>
            <a class="dropdown-item kanban-rename kill-drop" @click="emit('rename')"> Rename </a>
            <a class="dropdown-item kanban-collapse kill-drop" @click="emit('collapse')"> Collapse </a>
