...
<template>
    <div id="task-panel" :class="[activePanel === 'task' && 'is-active']" class="right-panel-wrapper is-task">
            ...
            <div class="right-panel-body has-slimscroll" data-simplebar>
                <div class="task-group task-overview">
                    ...
                    <div class="task-description">
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Videmus igitur ut conquiescere ne
                            infantes quidem possint. Duo Reges: constructio interrete... <a>See More</a>
                        </p>
                    </div>
                    ...
                    <div class="task-files">
                        <div class="file-box">
                            ...
                            <div class="meta">
                                ...
                                <span>3MB <i aria-hidden="true" class="fas fa-circle"></i> 5 days ago</span>
                            </div>
                            <FileCardDropdown />
                        </div>
                        <div class="file-box">
                            ...
                            <div class="meta">
                                ...
                                <span>0.6MB <i aria-hidden="true" class="fas fa-circle"></i> 8 days ago</span>
                            </div>
                            <FileCardDropdown />
                        </div>
                        <div class="file-box">
                            ...
                            <div class="meta">
                                <span>POC Demo</span>
                                <span>8.75MB <i aria-hidden="true" class="fas fa-circle"></i> 8 days ago</span>
                            </div>
                            <FileCardDropdown />
                        </div>
                    </div>
                ...
                <div class="task-group">
                    ...
                    <div class="field has-textarea-addon">
                        <div class="control">
                            <textarea class="textarea" rows="3" placeholder="Send a quick message..."></textarea>
                        </div>
